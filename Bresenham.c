...
void lineBres(int x1, int y1, int x2, int y2, int r, int g, int b) // point1, point2, R, G, B
{
	int dx = abs(x2 - x1), dy = abs(y2 - y1);
	int p, twoDy, twoDyDx;
	int x, y, xEnd, yEnd, IorD; // IorD => gradient : decrease (-1<m<0) increase (0<m<1)
...
int main() {
	...
	lineBres(200, 200, 350, 350, 100, 0, 255);
